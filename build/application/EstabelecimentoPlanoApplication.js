...
var EstabelecimentoPlanoService = require("../service/EstabelecimentoPlanoService");
exports.get = function (request, response) { return tslib_1.__awaiter(_this, void 0, void 0, function () {
    var estabelecimentoPlano, err_1;
    return tslib_1.__generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                _a.trys.push([0, 2, , 3]);
                return [4 /*yield*/, EstabelecimentoPlanoService.selectAll(request.query)];
            case 1:
...
exports.getById = function (request, response) { return tslib_1.__awaiter(_this, void 0, void 0, function () {
    var estabelecimentoPlano, err_2;
    return tslib_1.__generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                _a.trys.push([0, 2, , 3]);
                return [4 /*yield*/, EstabelecimentoPlanoService.selectById(request.params.id)];
            case 1:
                estabelecimentoPlano = _a.sent();
                response.status(statusHTTP_1.statusHTTPCode.sucessResponse.Accepted);
                response.send(estabelecimentoPlano);
...
exports.post = function (request, response) { return tslib_1.__awaiter(_this, void 0, void 0, function () {
    var estabelecimentoPlano, err_3;
    return tslib_1.__generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                _a.trys.push([0, 2, , 3]);
                return [4 /*yield*/, EstabelecimentoPlanoService.save(request.body)];
            case 1:
                estabelecimentoPlano = _a.sent();
...
exports.put = function (request, response) { return tslib_1.__awaiter(_this, void 0, void 0, function () {
    var estabelecimentoPlano, err_4;
    return tslib_1.__generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                _a.trys.push([0, 2, , 3]);
                return [4 /*yield*/, EstabelecimentoPlanoService.upgrade(request.body)];
            case 1:
                estabelecimentoPlano = _a.sent();
                response.status(statusHTTP_1.statusHTTPCode.sucessResponse.Created);
                response.send(estabelecimentoPlano);
...
exports.del = function (request, response) { return tslib_1.__awaiter(_this, void 0, void 0, function () {
    var estabelecimentoPlano, err_5;
    return tslib_1.__generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                _a.trys.push([0, 2, , 3]);
                return [4 /*yield*/, EstabelecimentoPlanoService.remove(request.body)];
            case 1:
                estabelecimentoPlano = _a.sent();
...
//# sourceMappingURL=EstabelecimentoPlanoApplication.js.map