...
var ConsumidorService = require("../service/ConsumidorService");
exports.get = function (request, response) { return tslib_1.__awaiter(_this, void 0, void 0, function () {
    var consumidor, err_1;
    return tslib_1.__generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                _a.trys.push([0, 2, , 3]);
                return [4 /*yield*/, ConsumidorService.selectAll(request.query)];
            case 1:
                consumidor = _a.sent();
...
exports.getById = function (request, response) { return tslib_1.__awaiter(_this, void 0, void 0, function () {
    var consumidor, err_2;
    return tslib_1.__generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                _a.trys.push([0, 2, , 3]);
                return [4 /*yield*/, ConsumidorService.selectById(request.params.id)];
            case 1:
                consumidor = _a.sent();
                response.status(statusHTTP_1.statusHTTPCode.sucessResponse.Accepted);
                response.send(consumidor);
...
exports.post = function (request, response) { return tslib_1.__awaiter(_this, void 0, void 0, function () {
    var consumidor, err_3;
    return tslib_1.__generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                _a.trys.push([0, 2, , 3]);
                return [4 /*yield*/, ConsumidorService.save(request.body)];
            case 1:
                consumidor = _a.sent();
...
exports.put = function (request, response) { return tslib_1.__awaiter(_this, void 0, void 0, function () {
    var consumidor, err_4;
    return tslib_1.__generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                _a.trys.push([0, 2, , 3]);
                return [4 /*yield*/, ConsumidorService.upgrade(request.body)];
            case 1:
                consumidor = _a.sent();
                response.status(statusHTTP_1.statusHTTPCode.sucessResponse.Created);
                response.send(consumidor);
...
exports.del = function (request, response) { return tslib_1.__awaiter(_this, void 0, void 0, function () {
    var consumidor, err_5;
    return tslib_1.__generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                _a.trys.push([0, 2, , 3]);
                return [4 /*yield*/, ConsumidorService.remove(request.body)];
            case 1:
                consumidor = _a.sent();
...
//# sourceMappingURL=ConsumidorApplication.js.map