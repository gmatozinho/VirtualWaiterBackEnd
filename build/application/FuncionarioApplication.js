...
var FuncionarioService = require("../service/FuncionarioService");
exports.get = function (request, response) { return tslib_1.__awaiter(_this, void 0, void 0, function () {
    var funcionario, err_1;
    return tslib_1.__generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                _a.trys.push([0, 2, , 3]);
                return [4 /*yield*/, FuncionarioService.selectAll(request.query)];
            case 1:
                funcionario = _a.sent();
...
exports.getById = function (request, response) { return tslib_1.__awaiter(_this, void 0, void 0, function () {
    var funcionario, err_2;
    return tslib_1.__generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                _a.trys.push([0, 2, , 3]);
                return [4 /*yield*/, FuncionarioService.selectById(request.params.id)];
            case 1:
                funcionario = _a.sent();
                response.status(statusHTTP_1.statusHTTPCode.sucessResponse.Accepted);
                response.send(funcionario);
...
exports.post = function (request, response) { return tslib_1.__awaiter(_this, void 0, void 0, function () {
    var funcionario, err_3;
    return tslib_1.__generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                _a.trys.push([0, 2, , 3]);
                return [4 /*yield*/, FuncionarioService.save(request.body)];
            case 1:
                funcionario = _a.sent();
...
exports.put = function (request, response) { return tslib_1.__awaiter(_this, void 0, void 0, function () {
    var funcionario, err_4;
    return tslib_1.__generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                _a.trys.push([0, 2, , 3]);
                return [4 /*yield*/, FuncionarioService.upgrade(request.body)];
            case 1:
                funcionario = _a.sent();
                response.status(statusHTTP_1.statusHTTPCode.sucessResponse.Created);
                response.send(funcionario);
...
exports.del = function (request, response) { return tslib_1.__awaiter(_this, void 0, void 0, function () {
    var funcionario, err_5;
    return tslib_1.__generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                _a.trys.push([0, 2, , 3]);
                return [4 /*yield*/, FuncionarioService.remove(request.body)];
            case 1:
                funcionario = _a.sent();
...
//# sourceMappingURL=FuncionarioApplication.js.map