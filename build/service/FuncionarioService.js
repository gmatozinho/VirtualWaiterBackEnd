...
var FuncionarioEntity_1 = require("../entity/FuncionarioEntity");
...
exports.selectAll = function (params) { return tslib_1.__awaiter(_this, void 0, void 0, function () {
    var builder, builtQuery, repository, funcionarios, err_1, det;
    return tslib_1.__generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                ...
                repository = typeorm_1.getRepository(FuncionarioEntity_1.Funcionario);
...
exports.selectById = function (id) { return tslib_1.__awaiter(_this, void 0, void 0, function () {
    var repository, funcionario, err_2, det;
    return tslib_1.__generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                _a.trys.push([0, 2, , 3]);
...
exports.save = function (body) { return tslib_1.__awaiter(_this, void 0, void 0, function () {
    var repository, funcionarios, savedData, err_3, det;
    return tslib_1.__generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                _a.trys.push([0, 2, , 3]);
                repository = typeorm_1.getRepository(FuncionarioEntity_1.Funcionario);
                funcionarios = repository.create(body);
                return [4 /*yield*/, repository.save(funcionarios)];
            case 1:
                savedData = _a.sent();
...
exports.upgrade = function (body) { return tslib_1.__awaiter(_this, void 0, void 0, function () {
    var repository, funcionarios, upgradedData, err_4, det;
    return tslib_1.__generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                _a.trys.push([0, 2, , 3]);
...
exports.remove = function (body) { return tslib_1.__awaiter(_this, void 0, void 0, function () {
    var zero, repository, ArrayIds, funcionarios, removedData, oldData, err_5, det;
    return tslib_1.__generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                _a.trys.push([0, 5, , 6]);
            ...
            case 1:
                funcionarios = _a.sent();
                if (!(funcionarios !== undefined && funcionarios.length > zero)) return [3 /*break*/, 3];
                funcionarios.forEach(function (element) { return element.ativo = false; });
                return [4 /*yield*/, repository.save(funcionarios)];
            case 2:
                removedData = _a.sent();
