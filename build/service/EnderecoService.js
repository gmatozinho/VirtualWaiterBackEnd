...
var EnderecoEntity_1 = require("../entity/EnderecoEntity");
...
exports.selectAll = function (params) { return tslib_1.__awaiter(_this, void 0, void 0, function () {
    var builder, builtQuery, repository, enderecos, err_1, det;
    return tslib_1.__generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                ...
                repository = typeorm_1.getRepository(EnderecoEntity_1.Endereco);
                return [4 /*yield*/, repository.find(builtQuery)];
            case 1:
                enderecos = _a.sent();
                return [2 /*return*/, enderecos];
            case 2:
                err_1 = _a.sent();
...
exports.selectById = function (id) { return tslib_1.__awaiter(_this, void 0, void 0, function () {
    var repository, endereco, err_2, det;
    return tslib_1.__generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                _a.trys.push([0, 2, , 3]);
...
exports.save = function (body) { return tslib_1.__awaiter(_this, void 0, void 0, function () {
    var repository, enderecos, savedData, err_3, det;
    return tslib_1.__generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                _a.trys.push([0, 2, , 3]);
                repository = typeorm_1.getRepository(EnderecoEntity_1.Endereco);
                enderecos = repository.create(body);
                return [4 /*yield*/, repository.save(enderecos)];
            case 1:
                savedData = _a.sent();
...
exports.upgrade = function (body) { return tslib_1.__awaiter(_this, void 0, void 0, function () {
    var repository, enderecos, upgradedData, err_4, det;
    return tslib_1.__generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                _a.trys.push([0, 2, , 3]);
