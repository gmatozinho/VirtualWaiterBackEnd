...
var ItemEntity_1 = require("../entity/ItemEntity");
...
exports.selectAll = function (params) { return tslib_1.__awaiter(_this, void 0, void 0, function () {
    var builder, builtQuery, repository, itens, err_1, det;
    return tslib_1.__generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                ...
                repository = typeorm_1.getRepository(ItemEntity_1.Item);
...
exports.save = function (body) { return tslib_1.__awaiter(_this, void 0, void 0, function () {
    var repository, itens, savedData, err_3, det;
    return tslib_1.__generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                _a.trys.push([0, 2, , 3]);
                repository = typeorm_1.getRepository(ItemEntity_1.Item);
                itens = repository.create(body);
                return [4 /*yield*/, repository.save(itens)];
            case 1:
                savedData = _a.sent();
...
exports.upgrade = function (body) { return tslib_1.__awaiter(_this, void 0, void 0, function () {
    var repository, itens, upgradedData, err_4, det;
    return tslib_1.__generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                _a.trys.push([0, 2, , 3]);
