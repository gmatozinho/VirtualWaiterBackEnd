...
var CardapioEntity_1 = require("../entity/CardapioEntity");
...
exports.selectAll = function (params) { return tslib_1.__awaiter(_this, void 0, void 0, function () {
    var builder, builtQuery, repository, cardapios, err_1, det;
    return tslib_1.__generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                ...
                repository = typeorm_1.getRepository(CardapioEntity_1.Cardapio);
                return [4 /*yield*/, repository.find(builtQuery)];
            case 1:
                cardapios = _a.sent();
                return [2 /*return*/, cardapios];
            case 2:
                err_1 = _a.sent();
...
exports.selectById = function (id) { return tslib_1.__awaiter(_this, void 0, void 0, function () {
    var repository, cardapio, err_2, det;
    return tslib_1.__generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                _a.trys.push([0, 2, , 3]);
...
exports.save = function (body) { return tslib_1.__awaiter(_this, void 0, void 0, function () {
    var repository, cardapios, savedData, err_3, det;
    return tslib_1.__generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                _a.trys.push([0, 2, , 3]);
                repository = typeorm_1.getRepository(CardapioEntity_1.Cardapio);
                cardapios = repository.create(body);
                return [4 /*yield*/, repository.save(cardapios)];
            case 1:
                savedData = _a.sent();
...
exports.upgrade = function (body) { return tslib_1.__awaiter(_this, void 0, void 0, function () {
    var repository, cardapios, upgradedData, err_4, det;
    return tslib_1.__generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                _a.trys.push([0, 2, , 3]);
...
exports.remove = function (body) { return tslib_1.__awaiter(_this, void 0, void 0, function () {
    var zero, repository, ArrayIds, cardapios, removedData, oldData, err_5, det;
    return tslib_1.__generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                _a.trys.push([0, 5, , 6]);
            ...
            case 1:
                cardapios = _a.sent();
                if (!(cardapios !== undefined && cardapios.length > zero)) return [3 /*break*/, 3];
                cardapios.forEach(function (element) { return element.ativo = false; });
                return [4 /*yield*/, repository.save(cardapios)];
            case 2:
                removedData = _a.sent();
