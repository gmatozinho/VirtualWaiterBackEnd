...
var DonoEntity_1 = require("../entity/DonoEntity");
...
exports.selectAll = function (params) { return tslib_1.__awaiter(_this, void 0, void 0, function () {
    var builder, builtQuery, repository, donos, err_1, det;
    return tslib_1.__generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                ...
                repository = typeorm_1.getRepository(DonoEntity_1.Dono);
                return [4 /*yield*/, repository.find(builtQuery)];
            case 1:
                donos = _a.sent();
                return [2 /*return*/, donos];
            case 2:
                err_1 = _a.sent();
...
exports.save = function (body) { return tslib_1.__awaiter(_this, void 0, void 0, function () {
    var repository, donos, savedData, err_3, det;
    return tslib_1.__generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                _a.trys.push([0, 2, , 3]);
                repository = typeorm_1.getRepository(DonoEntity_1.Dono);
                donos = repository.create(body);
                return [4 /*yield*/, repository.save(donos)];
            case 1:
                savedData = _a.sent();
...
exports.upgrade = function (body) { return tslib_1.__awaiter(_this, void 0, void 0, function () {
    var repository, donos, upgradedData, err_4, det;
    return tslib_1.__generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                _a.trys.push([0, 2, , 3]);
...
//# sourceMappingURL=DonoService.js.map